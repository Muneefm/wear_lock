package mnf.android.wearlock.fragment;
...
import mnf.android.wearlock.AppController;
...
public class RingFragment extends Fragment {
    ...
    public static RingFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_ring, container, false);
        ringBtn = (CircularButton) v.findViewById(R.id.ring_btn);
        ringBtn.setImageDrawable(getResources().getDrawable(R.drawable.ic_phone_ring));
